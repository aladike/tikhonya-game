...
<div id="stick" hidden><i></i></div><div id="debug" hidden><span></span><button id="debug-items">Выдать блоки</button></div><div class="rotate-hint">↻ Поверни экран — так удобнее строить</div>
